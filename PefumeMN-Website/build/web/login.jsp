    ...
    <section class="fxt-template-animation fxt-template-layout1">
        <div class="container-fluid">
            <div class="row">
                    ...
                    <div class="fxt-content" >
                        <div class="fxt-header" style="margin-bottom: 15px">
                            ...
                            <div class="fxt-page-switcher">
                                <a href="login" class="switcher-text1 active">Đăng nhập</a>
                                <a href="register" class="switcher-text1">Đăng ký ngay</a>
                            </div>
                        </div>
                        <div class="fxt-form">
                            <p style="color: black">Chào mừng bạn đến với Luxury Perfume Store <br> Đăng nhập để có thể tận hưởng !</p>
                            ...
                            <form action="login" method="post">
                                <div class="form-group">
                                    <div class="fxt-transformY-50 fxt-transition-delay-1">
                                        <input type="text" class="form-control" name="username" placeholder="Tên đăng nhập" required value="${requestScope.uName}">
                                        <i class="fa-solid fa-user"></i>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="fxt-transformY-50 fxt-transition-delay-2">
                                        <input id="pass" type="${requestScope.check == null ? 'password' : 'text'}" class="form-control" name="password" placeholder="${requestScope.check == null ? 'Mật khẩu' : 'Hãy nhập mật khẩu mới'}" required value="${uPass}">
                                ...
                                <div class="fxt-transformY-50 fxt-transition-delay-2" style="display: flex; justify-content: space-between">
                                    <div>
                                        ...
                                        <label style="font-size: 15px; color: black" for="remember">Nhớ mật khẩu</label>
                                    </div>
                                    <div>
                                        <a style="color: black" href="forgot" class="switcher-text2">Quên mật khẩu</a>
                                    </div>
                                </div>
                                <div class="form-group">
                ...
                <div class="col-md-6 col-12 fxt-none-767 fxt-bg-img" data-bg-image="images/figure/jisoo.png"></div>
            </div>
        </div>
    </section>

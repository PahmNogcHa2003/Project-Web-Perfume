            ...
            <div id="viewcart_content">
                ...
                <c:if test="${sessionScope.cartSize != 0}">
                    <div class="row d-flex justify-content-center">
                        <div class="col-4">
                            <h4 class="heading">Sản phẩm của bạn</h4>
                        </div>
                        <div class="col-8">
                            ...
                            <div class="row">
                                <div class="col-lg-12 mt-2">
                                    ...
                                    <div class="row d-flex justify-content-between px-4">
                                        ...
                                        <h6 class="mb-1 text-right">$${sessionScope.cart == null || sessionScope.cartSize == 0 ? '0' : '2'}</h6>
                                    </div>
                                    <div class="row d-flex justify-content-between px-4" id="tax">
                                        <p class="mb-1 text-left">Tổng (Đã tính thuế)</p>
                                        <h6 class="mb-1 text-right" style="font-size: 18px; font-weight: bold;">
                                            $${sessionScope.cart == null || sessionScope.cartSize == 0 ? '0' : sessionScope.cart.getTotalMoney() + 2}
                                        </h6>
                                    </div>
                                    <span>
                                        <form action="viewcart" method="post">
                                            <input class="btn-block btn-blue" type="submit" value="Thanh toán" id="checkout"

                    ...
                    <div class="main_menu menu_two menu_position">
                        <nav>
                            <ul>
                                ...
                                <li>
                                    <a href="profile" class="active">Trang cá nhân</a>
                                </li>
                                <li>
                                    <a href="changepass">Bảo mật</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
                        ...
                        <div class="card-body text-center box_info">
                            ...
                            <form id="fima">
                                <label for="form_file" class="edit" value="aa">
                                    <div style="color: #0D6EFD;font-size: 16px">JPG, PNG (không lớn hơn 5 MB)
                        ...
                        <div class="container d-flex justify-content-center">
                            <div class="card p-3" style="margin: 10px 0">
                                <div class="d-flex flex-row justify-content-center text-align-center">
                                    ...
                                    <p class="text-dark" style="color:red">Ví Mua Sắm</p>
                                </div>
                                <div class="card-bottom pt-3 px-3 mb-2" style="padding: 10px">
                                    <div class="d-flex flex-row justify-content-between text-align-center">
                                        <div class="d-flex flex-column"><span>Số dư</span><p>&euro; <span class="text-white">${sessionScope.wallet.balance}</span></p></div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form method="post" action="profile">
                                ...
                                <div class="gx-3 mb-3">
                                    <label class="mb-1" for="inputFirstName">Họ và tên</label>
                                    <c:if test="${sessionScope.name!=null}">
                                        <input class="form-control acceptEdit" readonly  name="name" id="inputFirstName" type="text" placeholder="Họ và tên" value="${sessionScope.name}">
                                    </c:if>
                                </div>
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <label class="mb-1" for="inputOrgName">Vai trò</label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <c:if test="${sessionScope.address!=null}">
                                            <input class="form-control acceptEdit" readonly name="address" id="inputFirstName"  type="text" placeholder="Địa chỉ" value="${sessionScope.address}">
                                        </c:if>
                                    </div>
                                </div>
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <c:if test="${sessionScope.phone!=null}">
                                            <input class="form-control acceptEdit" readonly name="phone" id="inputFirstName"  type="text" placeholder="Số điện thoại" value="${sessionScope.phone}">
                                        </c:if>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <c:if test="${sessionScope.birthdate!=null}">
                                            <input class="form-control acceptEdit" readonly name="birthday" id="inputFirstName"  type="text" placeholder="Ngày sinh" value="${sessionScope.birthdate}">
                                        </c:if>
                                    </div>
                                </div>
                                <button style="" class="btn btn-primary" onclick="acceptRead()" id="buttonVip" type="button">Chỉnh sửa hồ sơ</button>
                                <button style="margin-top: 15px;padding-right: 20px ;padding-left: 20px" class="btn btn-primary"  onclick="notAccept()" id="buttonVip2" type="submit">Lưu</button>
                            </form>
                        </div>
                    </div>
                </div>

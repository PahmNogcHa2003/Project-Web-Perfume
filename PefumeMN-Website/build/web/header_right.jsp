                        ...
                        <li id="productsCart" class="mini_cart_wrapper">
                            ...
                            <div class="mini_cart mini_cart2">
                                <div class="cart_gallery" style="max-height: 250px; overflow-y: auto;">
                                    ...
                                    <c:if test="${sessionScope.cart == null || sessionScope.cartSize == 0}">
                                        <span style="color: black" class="header__cart-list--no-cart-msg">Trống !</span>
                                ...
                                <div class="mini_cart_table">
                                    <div class="cart_table_border">
                                        ...
                                        <div class="cart_total mt-10">
                                            <span style="color: black">Tổng (đã giảm giá) :</span>
                                            <span class="price" style="color: black">${sessionScope.cart.getTotalMoney()}$</span>
                                        </div>
                                ...
                                <div class="mini_cart_footer">
                                    <div class="cart_button">
                                        <a href="${sessionScope.account == null ? 'login' : 'viewcart'}">Giỏ hàng</a>
                                    </div>
                                </div>
                            </div>
                        </li>
                        ...
                        <c:if test="${sessionScope.account!=null}">
                            <li onclick="change()" style="position: relative; cursor: pointer;">
                                ...
                                <ul id="avt" class="header_avt" style="margin-top:25px;
                                    ...
                                    <li class="option_avt"><a href="#">Thanh toán</a>
                                    <li class="option_avt"><a href="${sessionScope.account.roleID==1?"admin":"profile"}">Tài khoản</a></li>
                                    <li class="option_avt">

                    ...
                    <div class="main_menu menu_two menu_position">
                        <nav>
                            <ul>
                                ...
                                <li>
                                    <a href="changepass" class="active" >Bảo mật</a>
                                </li>
...
nhân            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="card mb-4">
                        <div class="card-header" style="font-weight: 600">Thay đổi mật khẩu</div>
                        <div class="card-body">
                            ...
                            <form action="changepass" method="post">
                                <div class="mb-3" style="position: relative">
                                    <label class="mb-1" for="currentPassword">Mật khẩu cũ</label>
                                    <input name="oldpass" class="form-control" id="pass" required type="password" placeholder="Nhập mật khẩu cũ">
                                    <i id="iconsee" style="cursor: pointer" onclick="changeIcon(this)" class="fa-solid fa-eye-slash"></i>
                                </div>
                                <div class="mb-3" style="position: relative">
                                    <label class="mb-1" for="newPassword">Mật khẩu mới</label>
                                    <input oninput="checkNumberCharacter(this)" name="newpass" value="" class="form-control" id="pass1" required type="password" placeholder="Nhập mật khẩu mới">
                                    <i id="iconsee" style="cursor: pointer" onclick="changeIcon(this)" class="fa-solid fa-eye-slash"></i>
                                    <label style="color: red; display:none" class="mb-1" id="text1"></label>
                                </div>
                                <div class="mb-3" style="position: relative">
                                    <label class="mb-1" for="confirmPassword">Xác nhận mật khẩu</label>
                                    <input oninput="checkSame(this)" name="cfnewpass" class="form-control" id="pass2" required type="password" placeholder="Xác nhận mật khẩu">
                                    <i id="iconsee" style="cursor: pointer" onclick="changeIcon(this)" class="fa-solid fa-eye-slash"></i>
                                ...
                                <button style="margin-top: 10px" class="btn btn-primary" type="submit">Lưu</button>
                            </form>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <!-- Delete account card-->
                    <div class="card mb-4">
                        <h4 class="card-header">Xóa tài khoản</h4>
                        <div class="card-body">
                            <p>Xóa tài khoản của bạn là một hành động vĩnh viễn và không thể hoàn tác. Nếu bạn chắc chắn muốn xóa tài khoản của mình, hãy chọn nút bên dưới.</p>
                            <a href="deleteaccount?username=${user.userName}" class="btn btn-danger-soft text-danger" type="button">Tôi đã hiểu, chấp nhận xóa tài khoản</a>
                        </div>
                    </div>
                </div>
            </div>

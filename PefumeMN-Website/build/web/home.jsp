    ...
    <body>
                                ...
                                <div class="main_menu menu_two menu_position">
                                    <nav>
                                        <ul>
                                            ...
                                            <li><a href="aboutus">Thông tin cửa hàng</a></li>
        ...
        <section class="slider_section slider_section mb-66" style="margin-bottom: 0px">
            <div class="slider_area owl-carousel">
                <div class="single_slider d-flex align-items-center" style="background: url('images/slider/slider5.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="section_title">
                            <h2 class=text-shadow" style="font-size: 20px;"><span class="ani-fire">Các sản phẩm mới nhất 2024</span></h2>
                                                ...
                                                <div class="product_thumb">
                                                    ...
                                                    <div class="action_links">
                                                        <ul>
                                                            ...
                                                            <li class="wishlist">
                                                                <a href="#" onclick="toggleWishlist(${p.id})" title="Thêm vào mục yêu thích">
                                                ...
                                                <figcaption class="product_content">
                                                    ...
                                                    <div class="price_box">
                                                        <c:if test="${p.price != p.salePrice}">
                                                            <span class="old_price" id="oldprice"> ${p.price} $</span>
                                                        </c:if>
                                                        <span class="current_price ani-fire"> ${p.salePrice} $
                                                        </span>
                                                    </div>
                        ...
                        <div class="home_section_left">
                            ...
                            <div class="deals_product_area mb-68">
                                <div class="section_title section_title_style2">
                                    <h2><span class="ani-fire">Ưu đãi lớn</span></h2>
                                                ...
                                                <figure>
                                                    <div class="product_thumb">
                                                        ...
                                                        <div class="action_links">
                                                            <ul>
                                                                ...
                                                                <li class="wishlist">
                                                                    <a href="#" onclick="toggleWishlist(${hotDeal.id})" title="Thêm vào mục yêu thích">
                                                                        <i style="color: #f6692a" class="fa-solid fa-heart"></i>
                                                                    </a>
                                                                </li>
                                                                <li class="quick_button" >
                                                    ...
                                                    <figcaption class="product_content">
                                                        ...
                                                        <div class="product_timing">
                                                            <div id="" data-countdown="2024/03/18">
                                                        ...
                                                        <div class="price_box">
                                                            <span class="old_price">${hotDeal.price} $
                                                            </span>
                                                            <span class="current_price ani-fire">${hotDeal.salePrice} $</span>
                                                        </div>
                                                            ...
                                                            <figure 
                                                                ...
                                                                <figcaption class="product_content">
                                                                    ...
                                                                    <div class="price_box">
                                                                        ...
                                                                        <span class="current_price">${giftSet.salePrice} $</span>
                                                                    </div>
                                                                </figcaption>
                                                            </figure>
                                                        </article>
                            ...
                            <div class="newsletter_style2" id="newsletter">
                                <div class="newsletter_container">
                                    ...
                                    <div class="newsletter_content">
                                        <p>Đăng ký ngay để nhận tin tức và được giảm giá 25%.</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-9 col-md-12">
                        <div class="home_section_right">
                                                ...
                                                <article class="single_product">
                                                    <figure>
                                                        <div class="product_thumb">
                                                            ...
                                                            <div class="action_links">
                                                                <ul>
                                                                    ...
                                                                    <li class="wishlist">
                                                                        <a href="#" onclick="toggleWishlist(${t.id})" title="Thêm vào mục yêu thích">
                                                                            <i style="color: #f6692a" class="fa-solid fa-heart"></i>
                                                                        </a>
                                                                    </li>
                                                                    <li class="quick_button" 
                                                        ...
                                                        <figcaption class="product_content">
                                                            ...
                                                            <div class="price_box">
                                                                <span class="old_price"> ${t.price} $</span>
                            ...
                            <div class="product_area" >
                                <div class="section_title section_title_style2">
                                    <h2>Các sản phẩm đang giảm giá</h2>
                                </div>
                                                    ...
                                                    <div class="product_thumb">
                                                        ...
                                                        <div class="action_links">
                                                            <ul>
                                                                ...
                                                                <li class="wishlist">
                                                                    <a href="#" onclick="toggleWishlist(${i.id})" title="Thêm vào mục yêu thích">
                                                                        <i style="color: #f6692a" class="fa-solid fa-heart"></i>
                                                                    </a>
                                                                </li>
                                                                <li class="quick_button" 
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-7">
                            <div class="widgets_container contact_us">
                                ...
                                <div class="footer_desc">
                                    <p>Nhận tất cả các loại nước hoa từ chúng tôi trong vòng 2 ngày giao hàng. Chúng tôi thậm chí có thể đặt hàngnước hoa không có trong cơ sở dữ liệu của chúng tôi. Để làm điều đó vui lòng gửi E-mail của bạn đến E-mail của công ty.</p>
                                </div>
                                <p>
                            ...
                            <div class="widgets_container widget_menu">
                                ...
                                <div class="footer_menu">
                                    <ul>
                                        ...
                                        <li><a href="aboutus">Thông tin cửa hàng</a></li>
                                        <li><a href="refine?cid_refine=0">Mua hàng</a></li>
                                        <li><a href="refine?cid_refine=5">Bộ quà tặng</a></li>
                                        <li><a href="profile">Tài khoản</a></li>
                                        <li><a href="viewcart">Đặt hàng</a></li>
                                        <li><a href="viewwishlist">Mục yêu thích</a></li>
                                        <li><a href="contact">Thông tin liên hệ</a></li>
                                    </ul>
                                </div>
                            </div>
                                            ...
                                            <article class="single_product">
                                                <figure>
                                                    ...
                                                    <figcaption class="product_content">
                                                        ...
                                                        <div class="price_box">
                                                            <c:if test="${i.price != i.salePrice}">
                                                                <span class="old_price" style="color: white;"> ${p.price} $</span>
                                                            </c:if>
                                                            <span class="current_price" style="color: white;"> ${p.salePrice} $</span>
                                                        </div>
                                                    </figcaption>
                                                </figure>
                                            </article>

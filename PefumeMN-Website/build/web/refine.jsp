                            ...
                            <div class="testimonial_style_two mb-60 rightleft">
                                <div class="testimonial_container">
                                    ...
                                    <form id="f1" action="refine" method="get">
                                        ...
                                        <div class="section_title section_title_style2">
                                            <h2 style="font-size: 16px">Đánh giá sản phẩm</h2>
                                            <fieldset class="responsiveFacets_sectionContent " aria-hidden="false">
                                                <div class="responsiveFacets_sectionItemLabel">
                                                    <div>
                                                        ...
                                                        <div  id="option2"  style="margin-bottom: 10px;cursor: pointer" onclick="getNumberStar(this)">
                                                            ...
                                                            <span style="font-weight: 600; font-size: 15px; margin-left: 10px">Hơn</span>
                                                        </div>
                                            ...
                                            <fieldset class="responsiveFacets_sectionContent " aria-hidden="false">
                                                <div class="shopee-filter-group__body shopee-price-range-filter__edit">
                                                    <div class="shopee-price-range-filter__inputs" style="margin: 1.25rem 2px 0.625rem;
                                                         ...
                                                         align-items: center;
                                                         padding-right: 30px">
                                                        <input type="number" style="width: 90px" name="pricefrom" class="shopee-price-range-filter__input" placeholder="Từ $" value="${price1 == 0 ? "$ FROM" : price1}" step="0.5" min=1>
                                                        ...
                                                        <input type="number" style="width: 90px" name="priceto" class="shopee-price-range-filter__input" placeholder="Đến $" value="${price2 == 0 ? "" : price2}" step="0.5" min=1">
                                                    </div>
                                                    <button class="submit-price" style="">Lọc</button>
                                                </div>
                                            </fieldset>
                                        </div>
                                        <div class="section_title section_title_style2">
                                            <h2 style="font-size: 16px">Giảm giá</h2>
                                            <fieldset class="responsiveFacets_sectionContent " aria-hidden="false">
                                                <div>

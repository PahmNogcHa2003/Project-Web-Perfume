                                    ...
                                    <div style="padding: 10px 15px">
                                        <div class="d-flex justify-content-between p-md-1">
                                            ...
                                            <div style="text-align: end">
                                                <h4 style="color: #1B813A">Tổng các sản phẩm</h4>
                                                <p class="mb-0"></p>
                            ...
                            <div class="card">
                                <div style="padding: 10px 15px">
                                    <div class="d-flex justify-content-between p-md-1">
                                        ...
                                        <div style="text-align: end"> 
                                            <h4 style="color: #06439F;">Số lượng sản phẩm đã bán</h4>
                                            <p class="mb-0"></p>
                            ...
                            <div class="card">
                                <div style="padding: 10px 15px">
                                    <div class="d-flex justify-content-between p-md-1">
                                        ...
                                        <div style="text-align: end">
                                            <h4 style="color: #E94644;">Tổng doanh thu</h4>
                                            <p class="mb-0"></p>
                            ...
                            <div class="card">
                                <div style="padding: 10px 15px">
                                    <div class="d-flex justify-content-between p-md-1">
                                        ...
                                        <div style="text-align: end">
                                            <h4 style="color: #06439F;">Người dùng</h4>
                                            <p class="mb-0"></p>
                            ...
                            <div class="card">
                                <div style="padding: 10px 15px">
                                    <div class="d-flex justify-content-between p-md-1">
                                        ...
                                        <div style="text-align: end">
                                            <h4 style="color: black;">Tổng các loại sản phẩm</h4>
                                            <p class="mb-0"></p>
                            ...
                            <div class="card">
                                <div style="padding: 10px 15px">
                                    <div class="d-flex justify-content-between p-md-1">
                                        ...
                                        <div style="text-align: end">
                                            <h4 style="color: #1B813A;">Nhà cung cấp</h4>
                                            <p class="mb-0"></p>

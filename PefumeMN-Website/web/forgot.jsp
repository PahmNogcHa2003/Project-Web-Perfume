                        ...
                        <div class="fxt-content">
                            <div class="fxt-header">
                                ...
                                <div class="fxt-page-switcher">
                                    ...
                                    <a href="register" class="switcher-text1">Đăng ký</a>
                                </div>
                            </div>
                            <div class="fxt-form">
                                <h2 style="color: red">Quên mật khẩu</h2>
                                <c:if test="${requestScope.check == null}">
                                    <p>Để khôi phục mật khẩu của bạn</p>
                                </c:if>
                                <c:if test="${requestScope.check != null}">
                                    ...
                                    <c:if test="${requestScope.check == null || requestScope.check == 'false'}">
                                        <div class="form-group">
                                            <div class="fxt-transformY-50 fxt-transition-delay-1">
                                                <input type="email" class="form-control" name="email" placeholder="Email" required="required" value="${requestScope.email}">

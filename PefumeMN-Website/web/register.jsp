    ...
    <section class="fxt-template-animation fxt-template-layout1" >
        <div class="container-fluid">
            <div class="row">
                    ...
                    <div class="fxt-content" >
                        <div class="fxt-header" style="margin-bottom: 15px">
                            ...
                            <div class="fxt-page-switcher">
                                <a href="login" class="switcher-text1">Đăng nhập</a>
                                <a href="register" class="switcher-text1 active">Đăng ký</a>
                            </div>
                        </div>
                        <div class="fxt-form">
                            <p style="color :black">Hãy tạo một tài khoản miễn phí ! <br> Để có thể trải nghiệm các sản phẩm của chúng tôi</p>
                            <h2 style="color: red">Đăng ký ngay</h2>
                            <h5 style="color: red">${requestScope.error}</h5>
                            <form id="form" method="post">
                                <div class="form-group">
                                    <div class="fxt-transformY-50 fxt-transition-delay-1">
                                        <input type="name" class="form-control" name="name" placeholder="Họ và tên" required="required">
                                ...
                                <div class="form-group">
                                    <div style="margin-bottom: 10px">Ngày sinh :</div>
                                ...
                                <div class="form-group">
                                    <div class="fxt-transformY-50 fxt-transition-delay-4">
                                        <button onclick="submitForm()" class="fxt-btn-fill">Đăng ký</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div class="col-md-6 col-12 fxt-none-767 fxt-bg-img" data-bg-image="images/figure/rose1.jpg"></div>
            </div>
        </div>
    </section> 
